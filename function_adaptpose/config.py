...
def get_parse_args():
    ...
    parser.add_argument('--ba_range_m', default=20.5e-2, type=float, help='bone angle modification range.') #20.5e-2
    parser.add_argument('--ba_range_w', default=16.5e-2, type=float, help='bone angle modification range.') #16.5e-2
    ...
    parser.add_argument('--gloss_factord2d_temp', default=1, type=float, help='factor for d2d loss.')
    ...
    parser.add_argument('--gloss_factorfeedback', default=1e-3, type=float, help='not in use.')
