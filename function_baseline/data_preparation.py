...
def data_preparation(args):
    ...
    keypoints = create_2d_data(path.join('data', 'data_2d_' + args.dataset +
                               '_' + args.keypoints + '.npz'), dataset, tag=args.dataset_target)
    ...
    if args.dataset_target == '3dhp' or args.dataset_target == 'h36m':
        ...
        mpi3dhp_3d, mpi3dhp_2d = fetch_3dhp(
            'data/data_3dhp_gt_test.npz', keypoints_test)
